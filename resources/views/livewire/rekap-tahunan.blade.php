    ...
    <div class="flex flex-col">
        <div class="flex flex-row">
            <div class="flex flex-col w-1/2">
                ...
                <select wire:model="tahun" id="tahun" name="tahun" onchange="" class="mt-1 block w-full py-2 px-3 border border-gray-300 bg-white rounded-md shadow-sm focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm">
    ...
    <div>
        ...
        @if ($rekap->count() > 0)
            ...
            <div class="flex justify-end">
                {{-- <button wire:click="$emit('refreshComponent')">Refresh</button> --}}
